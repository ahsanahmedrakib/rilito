...
export const metadata: Metadata = {
  title: "Search — Rilito",
  description: "Search the full Rilito collection.",
};
      ...
      {!q ? (
        <div className="mx-auto flex max-w-md flex-col items-center py-16 text-center">
          ...
          <p className="mt-2 text-sm text-ink-500">
            Tip the search icon in the header, or browse the full collection
            below.
          </p>
          <Link
            href="/products"
          ...
          {results.length === 0 ? (
            <div className="mt-10 flex flex-col items-center rounded-2xl bg-white py-24 text-center ring-1 ring-ink-200/60">
              ...
              <p className="max-w-sm text-sm text-ink-500">
                Try a broader term like &ldquo;tee&rdquo;, &ldquo;jeans&rdquo;
                or &ldquo;panjabi&rdquo;, or browse the whole collection.
              </p>
              <Link
                href="/products"
