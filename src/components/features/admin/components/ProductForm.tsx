    ...
    >
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        ...
        <div className="sm:col-span-2">
          ...
          <textarea rows={4} className={cn(inputCls, "resize-none", errors.images && "border-red-400")} {...register("images")} />
          {fieldError("images")}
        </div>
        <div className="sm:col-span-2">
          <label className={labelCls}>Colors — "Name #hex" (one per line) *</label>
          <textarea rows={3} className={cn(inputCls, "resize-none", errors.colors && "border-red-400")} {...register("colors")} />
          {fieldError("colors")}
        </div>
      </div>
